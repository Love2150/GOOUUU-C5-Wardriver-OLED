...
//// Display stuff
// GOOUUU + 0.96" I2C OLED custom profile
// OLED: SDA=GPIO24, SCL=GPIO23, address 0x3C (0x3D fallback)
...
//// Battery stuff
// GOOUUU test board has no supported battery gauge.
// Leave HAS_BATTERY undefined so the primary I2C controller is free for OLED.
// #define HAS_BATTERY
#define I2C_SCL 4
#define I2C_SDA 5
...
//// Device stuff
// Tested GOOUUU board reports 4 MB flash and no usable PSRAM.
// #define HAS_PSRAM
#define HAS_GPS
#define HAS_SD
