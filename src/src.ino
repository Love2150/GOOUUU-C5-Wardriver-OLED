...
TwoWire oledWire = TwoWire(0);  // ESP32-C5 primary I2C controller; GPIO23/24 are invalid on LP I2C
Display display = Display(&oledWire, OLED_SDA, OLED_SCL, OLED_ADDR);
